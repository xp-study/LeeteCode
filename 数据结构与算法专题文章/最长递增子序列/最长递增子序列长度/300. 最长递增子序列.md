...
本题解一步步推导出最优的解法，并讨论为什么官方题解中，要用 d[i]*d*[*i*] 表示长度为 i*i* 的最长递增子序列的最小末尾数字。

> 注：如果下标 i从 00 开始，则 d[i]*d*[*i*] 表示长度为 i+1的最长递增子序列的最小末尾数字。
...
<video src="C:\Users\Administrator\Desktop\新建文件夹\images\最长递增子序列\2.mp4"></video>
...
<video src="C:\Users\Administrator\Desktop\新建文件夹\images\最长递增子序列\4.mp4"></video>
...
树状数组的方法可以参考 [逆序对树状数组解法](https://github.com/xp-study/LeeteCode/blob/main/数据结构与算法专题文章/逆序对问题/315. 计算右侧小于当前元素的个数.md)
